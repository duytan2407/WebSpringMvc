								...
								<li class="span3">
									<div class="thumbnail">
										<a class="zoomTool" href="product_details.html"
											...
											src="<c:url value="assets/user/img/bootstrap-ring.png"/> assets/user/img/s.png"
											alt=""></a>
									</div>
								</li>
							</ul>
								...
								<li class="span3">
									<div class="thumbnail">
										<a class="zoomTool" href="product_details.html"
											title="add to cart"><span class="icon-search"></span>
											QUICK VIEW</a> <a href="product_details.html"><img
											src="<c:url value="assets/user/img/bootstrap-ring.png"/> assets/user/img/i.jpg"
											alt=""></a>
									</div>
								</li>
								<li class="span3">
									<div class="thumbnail">
										<a class="zoomTool" href="product_details.html"
											title="add to cart"><span class="icon-search"></span>
											QUICK VIEW</a> <a href="product_details.html"><img
											src="<c:url value="assets/user/img/bootstrap-ring.png"/> assets/user/img/f.jpg"
											alt=""></a>
									</div>
								</li>
								<li class="span3">
									<div class="thumbnail">
										<a class="zoomTool" href="product_details.html"
											title="add to cart"><span class="icon-search"></span>
											QUICK VIEW</a> <a href="product_details.html"><img
											src="<c:url value="assets/user/img/bootstrap-ring.png"/> assets/user/img/h.jpg"
											alt=""></a>
									</div>
								</li>
								<li class="span3">
									<div class="thumbnail">
										<a class="zoomTool" href="product_details.html"
											title="add to cart"><span class="icon-search"></span>
											QUICK VIEW</a> <a href="product_details.html"><img
											src="<c:url value="assets/user/img/bootstrap-ring.png"/> assets/user/img/j.jpg"
											alt=""></a>
									</div>
								</li>
							</ul>
					...
					<li class="span4">
						<div class="thumbnail">
							<a class="zoomTool" href="product_details.html"
								...
								src="assets/user/img/d.jpg" alt=""></a>
							<div class="caption">
					...
					<li class="span4">
						<div class="thumbnail">
							<a class="zoomTool" href="product_details.html"
								title="add to cart"><span class="icon-search"></span> QUICK
								VIEW</a> <a href="product_details.html"><img
								src="assets/user/img/e.jpg" alt=""></a>
							<div class="caption">
								<h5>Manicure & Pedicure</h5>
								<h4>
									<a class="defaultBtn" href="product_details.html"
					...
					<li class="span4">
						<div class="thumbnail">
							<a class="zoomTool" href="product_details.html"
								title="add to cart"><span class="icon-search"></span> QUICK
								VIEW</a> <a href="product_details.html"><img
								src="assets/user/img/f.jpg" alt="" /></a>
							<div class="caption">
								<h5>Manicure & Pedicure</h5>
								<h4>
									<a class="defaultBtn" href="product_details.html"
